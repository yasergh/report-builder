 ...
 */
namespace Snono\ReportBuilder;

use DOMDocument;
use DOMNode;
use Snono\ReportBuilder\Adapter\CPDF;
use DOMXPath;
use Snono\ReportBuilder\Frame\Factory;
use Snono\ReportBuilder\Frame\FrameTree;
use HTML5_Tokenizer;
use HTML5_TreeBuilder;
use Snono\ReportBuilder\Image\Cache;
use Snono\ReportBuilder\Renderer\ListBullet;
use Snono\ReportBuilder\Css\Stylesheet;
...
class Dompdf
{
    ...
    */
    ...
    public function loadHtml($str, $encoding = 'UTF-8')
    {
        ...
        set_error_handler(array("\\Snono\\ReportBuilder\\Helpers", "record_warnings"));
