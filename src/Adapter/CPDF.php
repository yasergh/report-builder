...
namespace Snono\ReportBuilder\Adapter;

use Snono\ReportBuilder\Canvas;
...
use Snono\ReportBuilder\PhpEvaluator;
...
class CPDF implements Canvas
{
    ...
    protected function _convert_gif_bmp_to_png($image_url, $type)
    {
        ...
        if (!function_exists($func_name)) {
            ...
            $func_name = "\\Snono\ReportBuilder\\Helpers::" . $func_name;
        }
