 ...
 */
namespace Snono\ReportBuilder\Frame;

use Snono\ReportBuilder\Css\Style;
use Snono\ReportBuilder\Dompdf;
use Snono\ReportBuilder\Exception;
use Snono\ReportBuilder\Frame;
use Snono\ReportBuilder\FrameDecorator\AbstractFrameDecorator;
use DOMXPath;
use Snono\ReportBuilder\FrameDecorator\Page as PageFrameDecorator;
use Snono\ReportBuilder\FrameReflower\Page as PageFrameReflower;
use Snono\ReportBuilder\Positioner\AbstractPositioner;
...
class Factory
{
    ...
    static function decorate_frame(Frame $frame, Dompdf $dompdf, Frame $root = null)
    {
        ...
        $decorator  = "Snono\ReportBuilder\\FrameDecorator\\$decorator";
        $reflower   = "Snono\ReportBuilder\\FrameReflower\\$reflower";
    ...
    protected static function getPositionerInstance($type)
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\\Snono\ReportBuilder\\Positioner\\'.$type;
